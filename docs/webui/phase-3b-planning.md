...
| Status | Planning complete; Phase 3B implementation **complete** (see [phase-3b-real-provider-readonly-integration.md](phase-3b-real-provider-readonly-integration.md)) — real provider remains **disabled by default** |
| Date | 2026-06-16 |
