...
for arg in "$@"; do
  case "$arg" in
    ...
    --help|-h)
      ...
      echo "  all                                  Run Profile A..O (default; never runs the manual one-shot live profile)"
