...
const _themes = {
  ...
  song: {
    ...
    description: 'Dark lacquer architecture framing warm garden light',
    category: 'eastern',
    colorScheme: 'dark',
    previewColors: {
      background: '#100e0d',
  ...
  ink: {
    ...
    description: 'Moon-white workbench with mist, mountains, and bamboo shadow',
    category: 'eastern',
    colorScheme: 'light',
    previewColors: {
      background: '#edf0ed',
  ...
  'sakura-night': {
    ...
    description: 'Cinematic indigo spring night with moonlit blossom depth',
    category: 'eastern',
    colorScheme: 'dark',
    previewColors: {
      background: '#101528',
